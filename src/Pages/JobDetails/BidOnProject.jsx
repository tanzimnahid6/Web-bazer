...
const BidOnProject = () => {
  ...
  const { email, deadline, maximum, minimum, jobTile } = jobs;
      ...
      <div>
        <form onSubmit={handleBid}>
          ...
          <input
            ...
            className={`block md:w-full w-11/12 rounded text-[#fcf540] bg-gradient-to-r from-[#193e51] to-[#146666] px-7 pb-2.5 pt-3 text-sm font-medium uppercase mx-auto ${
