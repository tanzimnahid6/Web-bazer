      ...
      <div className="flex justify-center">
        <div className="hero-content text-center text-neutral-content w-full ">
          <div className="md:w-2/4 w-full ">
            <h2 className="text-[#193e51] font-bold md:text-4xl text-2xl py-4">
              Please Log in
            </h2>
            <p className="text-gray-800 font-semibold">If you want ,you can login with this credential !</p>
            <div className="text-left font-bold  flex gap-12 justify-center mb-4">
              <div className="flex items-center gap-2 cursor-pointer hover:text-black ">
                <span>Email:bob@gmail.com</span>
                <CopyToClipboard text="bob@gmail.com">
                  <span
                    className="btn btn-xs btn-outline"
                    onClick={() => setIsCopiedEmail(true)}
                  >
