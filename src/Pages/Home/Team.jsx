      ...
      <section className=" text-center">
        ...
        <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 mt-36">
          <div className="mb-24 md:mb-0">
            <div className="block h-full rounded-lg bg-white dark-bg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          ...
          <div className="mb-24 md:mb-0">
            <div className="block h-full rounded-lg bg-white dark-bg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              ...
              <div className="p-6">
                ...
                <p className="mb-6">Marketing Manager</p>
                <ul className="mx-auto flex list-inside justify-center">
                  <a href="#!" className="px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
