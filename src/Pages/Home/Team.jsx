...
const Team = () => {
    return (
        <div>
            ...
            <h1 className='headings text-center my-10 text-3xl md:text-5xl'> Our team</h1>
    ...
    <div className="grid gap-x-6 md:grid-cols-4 lg:gap-x-12 mt-36">
      <div className="mb-24 md:mb-0">
        <div
          ...
          <div className="p-6">
            ...
            <p className="mb-6">Brand Manager</p>
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
            
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  className="h-4 w-4 text-[#c3bd2e] dark:text-[#c3bd2e]-400">
              ...
              <a href="#!" className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  className="h-3.5 w-3.5 text-[#c3bd2e] dark:text-[#c3bd2e]-400">
                  <path fill="currentColor"
      ...
      <div className="mb-24 md:mb-0">
        <div
          ...
          <div className="p-6">
            <h5 className="mb-4 text-lg font-bold">John Johnson</h5>
            <p className="mb-6">Analytics Specialist</p>
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
               
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#c3bd2e] dark:text-[#c3bd2e]-400"
      ...
      <div className="mb-24 md:mb-0">
        <div
          ...
          <div className="p-6">
            ...
            <p className="mb-6">Sales and Marketing Manager</p>
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
      ...
      <div className="">
        <div
          ...
          <div className="p-6">
            ...
            <p className="mb-6">Social Media Manager</p>
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
