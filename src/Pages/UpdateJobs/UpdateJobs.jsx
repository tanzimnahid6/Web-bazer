...
const UpdateJobs = () => {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(
      `https://b8a11-server-side-sumaiyakhan322.vercel.app/addJobs/${_id}`,
      {
        method: "PUT",
        headers: {
        ...
        <div>
          <form onSubmit={handleUpdate}>
            ...
            <div className="flex flex-col md:flex-row gap-10 my-10">
              ...
              <div className="relative h-12 w-full flex items-center justify-center gap-2">
                <label htmlFor="category" className="text-[#194a63] font-bold">
                  Category:
                </label>
                <select
            ...
            <div className="flex flex-col md:flex-row gap-10 my-10">
              <div className="relative h-12 w-full flex items-center justify-center gap-2">
                <label htmlFor="min" className="text-[#194a63] font-bold">
                  Minimum($):
                </label>
              ...
              <div className="relative h-12 w-full flex items-center justify-center gap-2">
                <label htmlFor="max" className="text-[#194a63] font-bold">
                  Maximum($):
                </label>
            ...
            <div className="relative h-12 w-full flex items-center justify-center gap-2">
              <label htmlFor="Img" className="text-[#194a63] font-bold">
                Image:
              </label>
